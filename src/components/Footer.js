...
const Footer = () => {
    return (
        <footer className="footer">
            ...
            <div><FaCode className="footerLogo" size={25} /> <a href="https://github.com/michaelbaud/drone_area" target="_blank" rel="noopener noreferrer">Code source du site</a></div>
